...
if _is_lto_kernel && [ "$_use_lto_suffix" = "yes"  ]; then
    _pkgsuffix=cachyos-cjktty-lto
elif ! _is_lto_kernel && [ "$_use_gcc_suffix" = "yes" ]; then
    _pkgsuffix=cachyos-cjktty-gcc
else
    _pkgsuffix=cachyos-cjktty
fi
...
prepare() {
    ...
    make "${BUILD_FLAGS[@]}" olddefconfig >/dev/null
...
b2sums=('b6734750e412140b728a6d18938c74a36bda5f2fb8f8658e3fb23b6cf13688d2f1c76fbf4d5337a80891ef77ade1fd70a80e8b7e4b5474f3b4c0cf4c3f3ff7cb'
